...
public final class ApplicationLoggers {
	...
	public static Logger appLogger 			= create("contactapp.logger", consoleHandler, applicationHandler);
	public static Logger modelLogger 		= create("contactapp.logger.model", modelHandler);
	public static Logger controllerLogger 	= create("contactapp.logger.controller", controllerHandler);
	public static Logger viewLogger 		= create("contactapp.logger.view", viewHandler);
	public static Logger utilsLogger 		= create("contactapp.logger.utils", utilsHandler);
